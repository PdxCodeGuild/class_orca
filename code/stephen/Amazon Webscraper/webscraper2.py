'''
Amazon Webscraper!
The purpose of this program is to scrape relevant data from amazon product url's in a csv.
    ...
    while loops < loops_count:
        ...
        for x, url in enumerate(tracker_urls):
            ...
            if price < tracker.buy_below[x]:
                ...
                send_email(tracker.code[x], tracker.buy_below[x])
            sleep(5)

def send_email(item, threshold):
