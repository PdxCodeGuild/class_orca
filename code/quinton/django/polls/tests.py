...
class QuestionModelTest(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        '''
        was_published_recently returns FALSE for questions whos pub_date is older than one day
        '''
...
class QuestionIndexViewTest(TestCase):
    def test_no_questions(self):
        '''
        if no question exists, a message is desplayed
        '''
    ...
    def test_further_question_and_past_questions(self):
        '''
