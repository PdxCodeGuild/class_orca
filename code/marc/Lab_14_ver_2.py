# This is Lab 14 Ver 2, The pick 6 problem, adding ROI
...
def main():
    ...
    lets_play = input("\nYou have $200,000. Do you want to blow it on lottery tickets?:\n 'y' or 'n'?\n")
    ...
    if lets_play == "y":
        ...
        while bankroll > 0:
            ...
            bankroll -= 2
            expenses += 2
            roi_percent = ((float(total_winnings) - float(expenses)) / float(expenses)) * 100
            print (f"Your ROI is {roi_percent}%\n")
    print (f'''\nYou blew your load on lottery tickets.
    You won ${total_winnings}! Your ROI is {roi_percent}%!
