...
## MVP 1/10 : 04 Jan, Monday, Working Fullscreen Lock, Django/Vue
...
## MVP 2/10 : 07 Jan, Thursday, Basic Keyboard functionality

   - each keypress interacts with screen:
      - v1: Keypress adds that character to screen at random position, set font size
      - v2: Keypress 

## MVP 3/10 : 11 Jan, Monday, Working User Login/Accounts
   - ***Question:*** Should this be MVP #2, within MVP 1, or can I push it off further?

## MVP 4/10 : 13 Jan, Wednesday DEPLOY TO WEB, via pythonAnywhere / etc.
...
## MVP 5/10 : 18 Jan, Monday Standard Draw Functionality:
...
## MVP 6/10 : 20 Jan, Wednesday Add optional background Music + Volume bar 
   - (default off, prefer keyboard on/off)
   
## MVP 7/10 : Future: Change user age (app mode)
...
## MVP 8/10 : Future: Save/Print Art
