...
def main():
    ...
    while True:
        ...
        input_number = input('Please enter a single number from 0-999, without decimals or fractions, or done to exit: ')
        ...
        #otherwise convert to a string, pass to function to convert, then repeat loop
        input_number = int(input_number)
        number_converter(input_number)
